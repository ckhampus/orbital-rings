...
- [ ] **CLOCK-01**: Station cycles through Morning, Day, Evening, and Night periods in an 8-minute real-time loop
- [ ] **CLOCK-02**: Clock cycle length and period proportions are configurable via Inspector resource
